...
class CheckHertronicAndMinistryAdmin
{
    /**
    ...
    public function handle($request, Closure $next)
    {
        ...
        if (Auth::guard('admin')->user()) {
            ...
            if($check_emp_type==false && !empty(Auth::guard('admin')->user()->type) && Auth::guard('admin')->user()->type =='HertronicAdmin' || Auth::guard('admin')->user()->type =='MinistryAdmin'){
                return $next($request);
            }
