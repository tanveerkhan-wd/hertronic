	...
	<div class="container-fluid">
		<div class="row ">
            <div class="col-12 mb-3">
                <h2 class="title"><span>{{$translations['sidebar_nav_user_management'] ?? 'User Management'}} > </span>{{$translations['sidebar_nav_ministry_super_admin'] ?? 'Ministry Super Admin'}}</h2>
            </div>   
            <div class="col-md-4 mb-3">
                <input type="text" id="search_ministry" class="form-control without_border icon_control search_control" placeholder="{{$translations['gn_search'] ?? 'Search'}}">
            </div>  
            ...
            <div class="col-md-2 col-6 mb-3">
                <a class="ajax_request no_sidebar_active" data-slug="admin/addMinistry" href="{{url('/admin/addMinistry')}}"><button class="theme_btn full_width small_btn">{{$translations['gn_add_new'] ?? 'Add New'}}</button></a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="theme_table">
                    <div class="table-responsive">
                        <table id="ministry_listing" class="display" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Sr. No.</th>
                                    <th>UID</th>
