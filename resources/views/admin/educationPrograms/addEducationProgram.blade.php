    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-12 mb-3">
                <h2 class="title"><a class="ajax_request no_sidebar_active" data-slug="admin/educationProgram" href="{{url('/admin/educationProgram')}}"><span>{{$translations['sidebar_nav_education_programs'] ?? 'Education Programs'}} > </span></a> {{$translations['gn_add_new'] ?? 'Add New'}}</h2>
            </div>   
                                                                                        ...
                                                                                        @if($sssValue['edp_ParentId']==$ssValue['pkEdp'])
                                                                                            ...
                                                                                            @foreach($sssValue['children'] as $spValue)
                                                                                                @if($spValue['edp_ParentId']==$sssValue['pkEdp'])
                                                                                                    <option value="{{$spValue['pkEdp']}}">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;{{$translations['gn_'] ?? $spValue['edp_Name']}}</option>
                                                                                                @endif
                                                                                            @endforeach
                                                                                        @endif
                                                                                    @endforeach
