    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-12 mb-3">
                <h2 class="title"><span>@if(Auth::guard('admin')->user()->type=='HertronicAdmin') {{$translations['sidebar_nav_ministry_masters'] ?? 'Ministry Masters'}} > @endif </span>{{$translations['sidebar_nav_education_plan'] ?? 'Education Plan'}}</h2>
            </div>   
            ...
            <div class="col-md-2 col-6 mb-3">
                <a class="ajax_request no_sidebar_active @if($logged_user->type !='MinistryAdmin') hide_content @endif" data-slug="admin/addEducationPlan" href="{{url('/admin/addEducationPlan')}}"><button class="theme_btn full_width small_btn">{{$translations['gn_add_new'] ?? 'Add New'}}</button></a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                        ...
                        <table id="education_plan_listing" class="display" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{$translations['sidebar_nav_grades'] ?? 'Grades'}}</th>
