	...
	<div class="container-fluid">
		<div class="row ">
            <div class="col-12 mb-3">
                <h2 class="title"><span>{{$translations['sidebar_nav_user_management'] ?? 'User Management'}} > </span><a class="ajax_request no_sidebar_active" data-slug="admin/subAdmins" href="{{url('/admin/subAdmins')}}"><span>{{$translations['gn_sub_admin'] ?? 'Sub Admin'}} > </span></a> {{$translations['gn_edit'] ?? 'Edit'}}</h2>
            </div>   
            <div class="col-12">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="adm_Phone" class="form-control" placeholder="{{$translations['gn_enter'] ?? 'Enter'}} {{$translations['gn_phone'] ?? 'Phone'}}" value="{{$data->adm_Phone}}">
                                        </div>
                                        <div class="form-group">
